...
var OpenAIAssistantAdapter = class {
  ...
  async submitUserMessage(threadId, forwardedProps) {
    ...
    const instructions = ((_a = forwardMessages.shift()) == null ? void 0 : _a.content) || "";
    forwardMessages = transformMessages(forwardMessages);
  ...
  async getResponse(forwardedProps) {
    ...
    } else if (forwardMessages.length > 0 && forwardMessages[forwardMessages.length - 1].role === "user" || forwardMessages[forwardMessages.length - 1].role === "system") {
  ...
  return messages.map((message) => {
    if (message.role === "system") {
      return {
        ...message,
        role: "user",
        content: "THE FOLLOWING MESSAGE IS NOT A USER MESSAGE. IT IS A SYSTEM MESSAGE: " + message.content
      };
    }
    return message;
  });
