const require_generated_tokens = require('./generated-tokens.cjs');
let lit = require("lit");
...
* here.
*/
const tok = (value) => (0, lit.unsafeCSS)(value);
const T = require_generated_tokens.GENERATED_DRAWER_TOKEN_DEFAULTS;
/**
