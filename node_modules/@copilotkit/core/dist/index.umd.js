	...
	var RunHandler = class {
		...
		*/
		async connectAgent({ agent }) {
			try {
				var _agent$threadId, _this$_lastConnectedT;
			...
			effects: [
				...
				createEffect((actions$, state$) => actions$.pipe(ofType(memoryRestEvents.credentialsSucceeded), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.filter)(([action, state]) => {
					...
					return (0, rxjs.defer)(() => {
						...
						return (0, rxjs.merge)((0, rxjs.of)(memoryDomainEvents.realtimeConnecting({ sessionId })), metadata$, join$, fatalStatus$).pipe((0, rxjs_operators.takeUntil)((0, rxjs.merge)(shutdown$, fatalSocketShutdown$.pipe((0, rxjs.observeOn)(rxjs.asapScheduler)))), (0, rxjs_operators.finalize)(() => {}));
					});
				})))
			]
		});
